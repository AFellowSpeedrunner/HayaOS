...
if #tArgs > 0 then
    ...
    print("To run a lua program, just type its name in the kernel shell.")
    return
end
...
while running do
    ...
    --    term.setTextColour( colours.yellow )
    --end
	local _luainputprefix = (_G._CCPC_DEBUGGER_ACTIVE and "lua_debug" or "lua")
	write(_luainputprefix.."_".._VERSION:sub(4,#_VERSION):gsub("%.","-").."> ")
    --term.setTextColour( colours.white )
